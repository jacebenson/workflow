...
PRODUCT ||--o{ ORDER-ITEM : "ordered in"`
    ...
    title: "Can ServiceNow Integrate",
    code: `graph TD
...
subgraph Fulfiller Task
  ...
  FTEmailGroup-->TaskComplete[Task Complete]
    ...
    title: "Concept Cloud V1 Discovery",
    code: `graph TD
...
DEP--Promoted-->COM`
    ...
    title: "Concept Event Mgmt Intake",
    code: `graph TD
OS(Outside System)
SN(Servicenow)
SE(Event)
...
SR-->E0`
    ...
    title: "Concept Integration Via Task",
    code: `graph TD
Start[Start]
Task1[Task 1]
Task2[Task 2]
...
subgraph SN Inbound Task Automation
  ...
  System2--API Call for Tasks Closes Task when complete-->Task2
    ...
    title: "Concept Order Of Operations",
    code: `sequenceDiagram
...
Note over uxux,dbdb: Thanks to http://www.snc-blog.com/2017/02/02/script-execution-flow/`
    ...
    title: "Concept Transform Map Order",
    code: `graph TD
...
R0-->E0`
    ...
    title: "Pattern Integration Import Set",
    code: `graph TD
