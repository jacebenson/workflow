...
loop Download
  ...
  subgraph CUSTOM
    ...
    SR-->E0`
        ...
        title: "conceptIntegrationViaTask",
        code: `graph TD
    Start[Start]
    Task1[Task 1]
    Task2[Task 2]
    ...
    subgraph SN Inbound Task Automation
      ...
      System2--API Call for Tasks Closes Task when complete-->Task2
        ...
        title: "conceptOrderOfOperations",
        code: `sequenceDiagram
...
Note over uxux,dbdb: Thanks to http://www.snc-blog.com/2017/02/02/script-execution-flow/`
        ...
        title: "conceptTransformMapOrder",
        code: `graph TD
...
`
        ...
        title: "patternIntegrationImportSet",
        code: `graph TD
...
`
        ...
        title: "standardZeroApprovalOneTaskSerial",
        code: `graph LR
S0(Start)
T1(Task 1)
E0(End)
...
T1-->E0`
        ...
        title: "standardZeroApprovalTwoTaskParallel",
        code: `graph LR
S0(Start)
T1(Task 1)
T2(Task 2)
...
T2-->E0`
        ...
        title: "standardZeroApprovalTwoTaskSerial",
        code: `graph LR
S0(Start)
T1(Task 1)
T2(Task 2)
...
T2-->E0`
        ...
        title: "standardOneApprovalOneTaskSerial",
        code: `graph LR
S0(Start)
A1(Approval 1)
T1(Task 1)
...
`
        ...
        title: "standardOneApprovalTwoTaskParallel",
        code: `graph LR
S0(Start)
A1(Approval 1)
T1(Task 1)
...
`
        ...
        title: "standardTwoApprovalOneTaskSerial",
        code: `graph LR
S0(Start)
A1(Approval 1)
A2(Approval 2)
...
`
        ...
        title: "standardTwoApprovalTwoTaskParallel",
        code: `graph LR
S0(Start)
A1(Approval 1)
A2(Approval 2)
